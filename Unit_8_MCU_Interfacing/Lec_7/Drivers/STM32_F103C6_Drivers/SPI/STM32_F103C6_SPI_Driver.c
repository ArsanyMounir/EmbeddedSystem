...
SPI_Config_t GL_SPI_Config_1;
SPI_Config_t GL_SPI_Config_2;
...
void MCAL_SPI_Init (SPI_TypeDef *SPIx,SPI_Config_t *SPI_Config)
{
	...
	if (SPIx == SPI1)
	{
		GL_SPI_Config_1 = *SPI_Config;
		GL_SPI_Config[0] = &GL_SPI_Config_1;
		RCC_SPI1_CLK_EN();
	}
	else if (SPIx == SPI2)
	{
		GL_SPI_Config_2 = *SPI_Config;
		GL_SPI_Config[1] = &GL_SPI_Config_2;
		RCC_SPI2_CLK_EN();
	}
